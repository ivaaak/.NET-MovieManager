...
namespace MovieManager.Services
{
    public class SearchMethodsService : ISearchMethodsService
    {
        ...
        //SearchResult
        public async Task<List<Infrastructure.Data.Models.Movie>> SearchMovieTitleToList(string SEARCH_NAME)
        {
            var results = await tmdbClient.SearchMovieAsync(SEARCH_NAME);

            List<Infrastructure.Data.Models.Movie> dbMovies = new List<Infrastructure.Data.Models.Movie>();
        ...
        public async Task<List<Infrastructure.Data.Models.Movie>> SearchShowTitleToList(string SEARCH_NAME)
        {
            var results = await tmdbClient.SearchTvShowAsync(SEARCH_NAME);

            List<Infrastructure.Data.Models.Movie> dbShows = new List<Infrastructure.Data.Models.Movie>();
